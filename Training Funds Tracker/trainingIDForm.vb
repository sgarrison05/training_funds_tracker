Public Class trainingIDForm
    ...
    Private Sub btnDone_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnDone.Click
        ...
        If txtJPOName.Text <> String.Empty And txtTrainingLocation.Text <> String.Empty _
            And txtTrainingName.Text <> String.Empty Then
        ...
        Else
            MessageBox.Show("Please fill in blank spaced on form", "Training Tracker", MessageBoxButtons.OK, _
